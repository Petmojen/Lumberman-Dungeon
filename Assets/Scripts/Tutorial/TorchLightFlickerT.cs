...
public class TorchLightFlickerT:MonoBehaviour
{
    [SerializeField] GameObject sparks, smoke;
    TutorialDarkness darknessRadius;
    ...
    void Start()
    {
        centerPoint = GameObject.FindGameObjectWithTag("Light");
        darknessRadius = FindObjectOfType<TutorialDarkness>();
